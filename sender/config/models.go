...
const (
    ...
    KeyFileWriteInterval      = "file_write_interval"
    ...
    KeyKafkaSASL                      = "kafka_sasl"
    KeyKafkaUserName                  = "kafka_sasl_username"
    KeyKafkaPassword                  = "kafka_sasl_password"
    KeyKafkaCA                        = "kafka_sasl_ca"
